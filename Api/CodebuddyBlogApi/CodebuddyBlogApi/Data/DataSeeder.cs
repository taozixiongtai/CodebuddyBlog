...
namespace CodebuddyBlogApi.Data
{
    public class DataSeeder
    {
        ...
        private async Task SeedArticleCategoryRelationsAsync()
        {
            ...
            {
                // 第1篇：C# 编程、.NET 开发
                new ArticleCategoryRelation { ArticleId = 1, CategoryId = 1 },
                new ArticleCategoryRelation { ArticleId = 1, CategoryId = 2 },

                // 第2篇：.NET 开发、API 设计
                new ArticleCategoryRelation { ArticleId = 2, CategoryId = 2 },
                new ArticleCategoryRelation { ArticleId = 2, CategoryId = 5 },

                // 第3篇：.NET 开发、数据库
                new ArticleCategoryRelation { ArticleId = 3, CategoryId = 2 },
                new ArticleCategoryRelation { ArticleId = 3, CategoryId = 4 },

                // 第4篇：Web 开发、API 设计
                new ArticleCategoryRelation { ArticleId = 4, CategoryId = 3 },
                new ArticleCategoryRelation { ArticleId = 4, CategoryId = 5 },

                // 第5篇：.NET 开发、数据库
                new ArticleCategoryRelation { ArticleId = 5, CategoryId = 2 },
                new ArticleCategoryRelation { ArticleId = 5, CategoryId = 4 },

                // 第6篇：数据库
                new ArticleCategoryRelation { ArticleId = 6, CategoryId = 4 },

                // 第7篇：Web 开发、API 设计
                new ArticleCategoryRelation { ArticleId = 7, CategoryId = 3 },
                new ArticleCategoryRelation { ArticleId = 7, CategoryId = 5 }
            };
